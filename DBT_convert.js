...
const protocolDisplayName = "DBT Daily Diary Card (E.B.)"

//2. create your raw github repo URL
const userName = 'hotavocado'
const repoName = 'DBT-JE-EB'
...
let imagePath = `https://raw.githubusercontent.com/ChildMindInstitute/DBT-pilot/main/images/png/`
...
let protocolAboutPath = `https://raw.githubusercontent.com/ChildMindInstitute/DBT-pilot/main/protocols/DBT_diary_card_pilot/README.md`
...
function createProtocolSchema(protocolName, protocolContextUrl) {
    let protocolSchema = {
        ...
        "schema:image": imagePath + 'DBT.png',
